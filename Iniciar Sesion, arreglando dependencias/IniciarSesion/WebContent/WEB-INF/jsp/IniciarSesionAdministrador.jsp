...
<body>
	<div class="container-fluid">
		<div class="container">
			<h2 class="text-center" id="title2"> &nbsp; Trofi &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Administrador</h2>
			<hr>
			<div class="row">
				...
				<div class="col-md-5">
					<form role="form" method="post" action="SesionIniciadaAdmin.html"
...
<div>
	<form role="form" method="post" action="Cliente.html" modelAttribute="login">
		<input type="submit" class="btn btn-success btn-lg" value="Cliente">
	</form>	
</div>
<div>
